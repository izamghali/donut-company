        ...
        <div className={`navbar bg-accent dark:bg-dark xl:px-10 px-2 flex justify-between text-white fill-white ${className} `}>
            ...
            <div className="flex-none">
                ...
                {/* <div className="lg:hidden flex ">
                    <label htmlFor="product-drawer" className=" drawer-button">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-5 h-5 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
                    </label>
                </div> */}

                <ul className="menu menu-horizontal px-1">
                    <div className="md:flex hidden xl:gap-24 lg:gap-16 std-duration">
                    ...
                    <div className="dropdown dropdown-end md:hidden flex">
                        ...
                        <ul tabIndex={0} className="mt-10 border-2 dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li><Link href={`/menu`}>Menu</Link></li>
                            <li><Link href={`/about`}>About</Link></li>
                            <li><Link href={`/team`}>Team</Link></li>
                        </ul>
