        ...
        <div className={`drawer dark:bg-dark dark:text-light  ${className}`}>
            ...
            <div className="drawer-content flex flex-col mt-16 dark:bg-dark">
                ...
                <div role="tablist" className="tabs 
                    ...
                    flex justify-center tabs-lifted mt-2
                    dark:bg-dark dark:text-light z-30
                ">
                    <button role="tab" className="tab tab-active">Donuts</button>
                    {/* content */}
                    <button role="tab" className="tab hidden sm:block">Cookies & Brownies</button>
                    <button role="tab" className="tab sm:hidden flex gap-2">
                    ...
                    {/* content */}
                    <button role="tab" className="tab">Beverage</button>
                    {/* content */}
                </div>

                {/* donut menu cards */}
                <div className="
                    h-[45rem] overflow-scroll 
                    lg:snap-none md:h-screen lg:h-full
                    flex flex-wrap xl:gap-8 gap-4 
                    justify-center lg:justify-start 
                    p-4 md:p-10 std-duration
                ">
                    {
            ...
            <div className="drawer-side border-r-2 dark:border-slate-400">
                ...
                {/* Sidebar content here */}
                    ...
                    <div className="flex flex-col gap-2">
                        <button className="drawer-menu-btn">Donuts</button>
                        <button className="drawer-menu-btn">Cookies & Brownies</button>
                        <button className="drawer-menu-btn">Beverage</button>
                    </div>
