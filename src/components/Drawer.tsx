    ...
    return (
        <div className={` drawer ${className}`}>
            ...
            <div className="drawer-content flex flex-col mt-16 dark:bg-dark">
                ...
                ">
                    <a role="tab" className="tab snap-center tab-active">Donuts</a>
                    {/* content */}
                    <a role="tab" className="tab snap-center hidden sm:block">Cookies & Brownies</a>
                    <a role="tab" className="tab snap-center sm:hidden flex gap-2">
                    ...
                    {/* content */}
                    <a role="tab" className="tab snap-center">Beverage</a>
                    {/* content */}
                </div>
